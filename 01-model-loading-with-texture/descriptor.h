...
namespace scg {
    ...
    void createDescriptorSets(scg::sDevice& s_device, scg::sDescriptor& s_descriptor, scg::sUniformBuffer& s_ubuf, scg::sTexture& s_texture);
    void createDescriptorPool(scg::sDevice& s_device, scg::sDescriptor& s_descriptor);
}

void scg::createDescriptorPool(sDevice& s_device, sDescriptor& s_descriptor) {
...
void scg::createDescriptorSets(scg::sDevice& s_device, scg::sDescriptor& s_descriptor, scg::sUniformBuffer& s_ubuf, scg::sTexture& s_texture) {
    std::vector<VkDescriptorSetLayout> layouts(maxFramesInFlight, s_descriptor.descriptorSetLayout);
    ...
    s_descriptor.descriptorSets.resize(maxFramesInFlight);
